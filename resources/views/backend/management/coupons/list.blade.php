...
@section('title',__('backend/management.coupons.title'))
@section('content')
<div class="container-fluid">
	<div class="row mt-4 g-md-3 g-3">
		<div class="col-lg-12">
		<a data-bs-toggle="offcanvas" data-bs-target="#add-coupon" aria-controls="add-coupon" href="#" class="btn-go-to-shop goshop_link" style="margin-bottom:15px">{{ __('backend/main.add') }}</a>
		</div>
		<!-- transaction -->
		<div class="col-lg-12">
				...
				<div class="mt-30 table-pc">
					...
					<table class="table mt-2 table-striped">
						...
						<thead class="d-md-table-header-group table-header-pc">
							<tr>
								<th scope="col" class="d-block d-md-table-cell">{{ __('backend/management.coupons.id') }} <span class="d-inline d-md-none">:</span></th>
								<th scope="col" class="d-block d-md-table-cell">{{ __('backend/management.coupons.code') }} <span class="d-inline d-md-none">:</span></th>
								<th scope="col" class="d-block d-md-table-cell">{{ __('backend/management.coupons.usage') }} <span class="d-inline d-md-none">:</span></th>
								<th scope="col" class="d-block d-md-table-cell">{{ __('backend/management.coupons.amount') }} <span class="d-inline d-md-none">:</span></th>
								<th scope="col" class="d-block d-md-table-cell">{{ __('backend/management.coupons.date') }} <span class="d-inline d-md-none">:</span></th>
								<th scope="col" class="d-block d-md-flex justify-content-end">{{ __('backend/management.coupons.actions') }} <span class="d-inline d-md-none">:</span></th>
							</tr>
						</thead>
						<tbody>
							@foreach($coupons as $coupon)
								<tr>
									<td scope="row" class="d-block d-md-table-cell">{{ $coupon->id }}</td>
									<td class="fs-20 d-block d-md-table-cell">{{ $coupon->code }}</td>
									...
									<td  class="fs-20 d-block d-md-flex justify-content-end">
										...
										<div class="d-flex">
											<div>												
												<a href="#"></a>
												<svg data-bs-toggle="offcanvas" data-bs-target="#edit-coupon_{{$coupon->id}}"
													aria-controls="edit-coupon" class="btn-update"
											...
											<div>
												<a href="{{ route('backend-management-coupon-delete', $coupon->id) }}">
												<svg class="btn-delete" xmlns="http://www.w3.org/2000/svg" viewBox="0 0 24 24"
													fill="none">
													<path d="M3 6H21" stroke="#BBBBBB" stroke-width="2" stroke-linecap="round"
														stroke-linejoin="round" />
										...
										<!-- canvas edit -->
										<div class="offcanvas offcanvas-end canvas-edit" tabindex="-1" id="edit-coupon_{{$coupon->id}}" aria-labelledby="offcanvasTopLabel">
											<!-- header-canvas-edit -->
    										<div class="offcanvas-header canvas-header row">
    											<div class="d-flex col-md-4 col-11">
    												...
    												<div>
    													<p class="name-canvas">{{ __('backend/management.coupons.edit.title') }}</p>
    													<p class="desc-canvas">#{{$coupon->id}}</p>
    												</div>
    											...
    											<div class="d-flex justify-content-end gap-3 gap-md-2 col-md-8">
    												...
    												<button class="btn-go-to-shop"><a href="{{ route('backend-management-coupons') }}">{{ __('backend/management.coupons.title') }}</a></button>
    											</div>
    										</div>
														...
														<div class="kt-portlet">
																<form method="post" class="kt-form" action="{{ route('backend-management-coupon-edit-form') }}">
																	...
																	<div class="kt-portlet__foot">
																	    <div class="mt-4">
                                											<button type="submit" class="btn-go-to-shop m-0">{{ __('backend/management.coupons.edit.submit_button') }}</button>
                                										</div>
																	</div>
																</form>
															</div>
		...
		<!-- canvas add -->
		<div class="offcanvas offcanvas-end canvas-edit" tabindex="-1" id="add-coupon" aria-labelledby="offcanvasTopLabel">
			<!-- header-canvas-add -->
                                            <div class="offcanvas-header canvas-header row">
    											<div class="d-flex col-md-4 col-11">
    												<div class="d-none d-md-block">
    												...
    												<div>
    													<p class="name-canvas">{{ __('backend/management.coupons.add.title') }}</p>
    												</div>
					...
					<div class="row">
						...
						<div class="kt-portlet">
								<form method="post" class="kt-form" action="{{ route('backend-management-coupon-add-form') }}">
									...
									<div class="kt-portlet__foot">
									    <div class="mt-4">
                                		    <button type="submit" class="btn-go-to-shop m-0">{{ __('backend/management.coupons.add.submit_button') }}</button>
                                		</div>
									</div>
								</form>
							</div>
		...
		<div class="col-lg-12 d-none d-md-block">
			<div class="bg-secondary rounded-2 p-3 d-flex justify-content-between align-items-center">
				<div class="f-flex info-paginition">coupons
					Showing <span class="info-paginition-span">{{ $coupons->firstItem() }} to {{ $coupons->lastItem() }}</span> of
					<span class="info-paginition-span">{{$coupons->total()}}</span> entries
				</div>
				<!-- pagination -->
				<div>
