...
@section('title',__('backend/management.delivery_methods.title'))
@section('content')
<div class="container-fluid">
	<div class="row mt-4 g-md-3 g-3">
		<div class="col-lg-12">
		<a data-bs-toggle="offcanvas" data-bs-target="#add-deliveryMethod" aria-controls="add-deliveryMethod" href="#" class="btn-go-to-shop goshop_link" style="margin-bottom:15px">{{ __('backend/main.add') }}</a>
		</div>
		<!-- transaction -->
		<div class="col-lg-12">
				...
				<div class="mt-30 table-pc">
					...
					<table class="table mt-2 table-striped">
						...
						<thead class="d-md-table-header-group table-header-pc">
							<tr>
								<th scope="col" class="d-block d-md-table-cell">{{ __('backend/management.delivery_methods.id') }} <span class="d-inline d-md-none">:</span></th>
								<th scope="col" class="d-block d-md-table-cell">{{ __('backend/management.delivery_methods.name') }} <span class="d-inline d-md-none">:</span></th>
								<th scope="col" class="d-block d-md-table-cell">{{ __('backend/management.delivery_methods.price') }} <span class="d-inline d-md-none">:</span></th>
								<th scope="col" class="d-block d-md-table-cell">{{ __('backend/management.delivery_methods.date') }} <span class="d-inline d-md-none">:</span></th>
								<th scope="col" class="d-block d-md-flex justify-content-end">{{ __('backend/management.delivery_methods.actions') }} <span class="d-inline d-md-none">:</span></th>
							</tr>
						</thead>
						<tbody>
							@foreach($deliveryMethods as $deliveryMethod)
								<tr>
									<td scope="row" class="d-block d-md-table-cell">{{ $deliveryMethod->id }}</td>
									<td class="fs-20 d-block d-md-table-cell">{{ $deliveryMethod->name }}</td>
									...
									<td  class="fs-20 d-block d-md-flex justify-content-end">
										<div class="d-flex">
											<div>
												<a href="#">
												<svg data-bs-toggle="offcanvas" data-bs-target="#edit-deliveryMethod_{{$deliveryMethod->id}}"
													aria-controls="edit-deliveryMethod" class="btn-update"
											...
											<div>
												<a href="{{ route('backend-management-delivery-method-delete', $deliveryMethod->id) }}">
												<svg class="btn-delete" xmlns="http://www.w3.org/2000/svg" viewBox="0 0 24 24"
													fill="none">
													<path d="M3 6H21" stroke="#BBBBBB" stroke-width="2" stroke-linecap="round"
														stroke-linejoin="round" />
										...
										<!-- canvas edit -->
										<div class="offcanvas offcanvas-end canvas-edit" tabindex="-1" id="edit-deliveryMethod_{{$deliveryMethod->id}}" aria-labelledby="offcanvasTopLabel">
											<!-- header-canvas-edit -->
    										<div class="offcanvas-header canvas-header row">
    											<div class="d-flex col-md-4 col-11">
    												...
    												<div>
    													<p class="name-canvas">{{ __('backend/management.delivery_methods.edit.title') }}</p>
    													<p class="desc-canvas">#{{$deliveryMethod->id}}</p>
    												</div>
    											...
    											<div class="d-flex justify-content-end gap-3 gap-md-2 col-md-8">
    												<button class="btn-go-to-shop"><a href="">{{ __('backend/management.title') }}</a></button>
    												<button class="btn-go-to-shop"><a href="{{ route('backend-management-delivery-methods') }}">{{ __('backend/management.delivery_methods.title') }}</a></button>
    											</div>
    										</div>
														...
														<div class="kt-portlet">
																<form method="post" class="kt-form" action="{{ route('backend-management-delivery-method-edit-form') }}">
																	...
																	<div class="kt-portlet__foot">
																	    <div class="mt-4">
                                											<button type="submit" class="btn-go-to-shop m-0">{{ __('backend/management.delivery_methods.edit.submit_button') }}</button>
                                										</div>
																	</div>
																</form>
															</div>
		...
		<!-- canvas add -->
		<div class="offcanvas offcanvas-end canvas-edit" tabindex="-1" id="add-deliveryMethod" aria-labelledby="offcanvasTopLabel">
		    <!-- header-canvas-add -->
    										<div class="offcanvas-header canvas-header row">
    											<div class="d-flex col-md-4 col-11">
    												<div class="d-none d-md-block">
    												...
    												<div>
    													<p class="name-canvas">{{ __('backend/management.delivery_methods.add.title') }}</p>
    												</div>
					...
					<div class="row">
						...
						<div class="kt-portlet">
								<form method="post" class="kt-form" action="{{ route('backend-management-delivery-method-add-form') }}">
									...
									<div class="kt-portlet__foot">
									    <div class="mt-4">
                                		    <button type="submit" class="btn-go-to-shop m-0">{{ __('backend/management.delivery_methods.add.submit_button') }}</button>
                                		</div>
									</div>
								</form>
							</div>
		...
		<div class="col-lg-12 d-none d-md-block">
			<div class="bg-secondary rounded-2 p-3 d-flex justify-content-between align-items-center">
				<div class="f-flex info-paginition">
					Showing <span class="info-paginition-span">{{ $deliveryMethods->firstItem() }} to {{ $deliveryMethods->lastItem() }}</span> of
					<span class="info-paginition-span">{{$deliveryMethods->total()}}</span> entries
				</div>
				<!-- pagination -->
				<div>
