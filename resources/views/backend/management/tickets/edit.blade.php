...
@section('title',__('backend/management.tickets.edit.title'))
@section('content')
...
<div class="k-content__body	k-grid__item k-grid__item--fluid mt-4">
	<div class="row">
		<div class="col-lg-12 col-xl-12 order-lg-1 order-xl-1">
			...
			<a href="{{ route('backend-management-ticket-close', $ticket->id) }}"
				...
				__('backend/management.tickets.edit.close') }}</a>
			@else
			<a href="{{ route('backend-management-ticket-open', $ticket->id) }}"
				class="btn btn-wide btn-bold btn-success btn-upper" style="margin-bottom:15px">{{
				__('backend/management.tickets.edit.open') }}</a>
			@endif
				...
				<div class="k-portlet__body k-portlet__body--fluid">
					<div style="width: 100%">
						...
						<form method="POST" class="kt-form" action="{{ route('backend-management-ticket-reply-form') }}"
							...
							<button type="submit" class="btn btn-wide btn-bold btn-danger">{{
