...
@section('title',__('backend/management.products.categories.title'))
@section('content')
<div class="container-fluid">
	<div class="row mt-4 g-md-3 g-3">
		<div class="col-lg-12">
			<a data-bs-toggle="offcanvas" data-bs-target="#add-productCategory" aria-controls="add-productCategory" href="#" class="btn-go-to-shop goshop_link" style="margin-bottom:15px">{{ __('backend/main.add') }}</a>
		</div>
		<!-- transaction -->
		<div class="col-lg-12">
				...
				<div class="mt-30 table-pc">
					...
					<table class="table mt-2 table-striped">
						...
						<thead class="d-md-table-header-group table-header-pc">
							...
							<tr>
								<th scope="col" class="d-block d-md-table-cell">{{ __('backend/management.products.categories.id') }} <span class="d-inline d-md-none">:</span></th>
								<th scope="col" class="d-block d-md-table-cell">{{ __('backend/management.products.categories.name') }} <span class="d-inline d-md-none">:</span></th>
								<th scope="col" class="d-block d-md-table-cell">{{ __('backend/management.products.categories.slug') }} <span class="d-inline d-md-none">:</span></th>
								<th scope="col" class="d-block d-md-flex justify-content-end">{{ __('backend/management.products.categories.actions') }} <span class="d-inline d-md-none">:</span></th>
							</tr>
						</thead>
						<tbody>
							@foreach($productsCategories as $productCategory)
							<tr>
								<td scope="row" class="d-block d-md-table-cell">{{ $productCategory->id }}</td>
								<td class="fs-20 d-block d-md-table-cell">{{ $productCategory->name }}</td>
								<td class="fs-20 d-block d-md-table-cell">{{ $productCategory->slug }}</td>
								<td class="fs-20 d-block d-md-flex justify-content-end">
									<div class="d-flex">
										<div>
											<a href="{{ route('backend-management-product-category-edit', $productCategory->id) }}">
											<svg data-bs-toggle="offcanvas" data-bs-target="#edit-productCategory"
												aria-controls="edit-productCategory" class="btn-update"
										...
										<div>
											<a href="{{ route('backend-management-product-category-delete', $productCategory->id) }}">
											<svg class="btn-delete" xmlns="http://www.w3.org/2000/svg" viewBox="0 0 24 24"
												fill="none">
												<path d="M3 6H21" stroke="#BBBBBB" stroke-width="2" stroke-linecap="round"
													stroke-linejoin="round" />
									...
									<!-- canvas add -->
									<div class="offcanvas offcanvas-end canvas-edit" tabindex="-1" id="add-productCategory" aria-labelledby="offcanvasTopLabel">
										<!-- header-canvas-add -->
		...
		<div class="col-lg-12 d-none d-md-block">
			<div class="bg-secondary rounded-2 p-3 d-flex justify-content-between align-items-center">
				<div class="f-flex info-paginition">
					Showing <span class="info-paginition-span">{{ $productsCategories->firstItem() }} to {{ $productsCategories->lastItem() }}</span> of
					<span class="info-paginition-span">{{$productsCategories->total()}}</span> entries
				</div>
				<!-- pagination -->
				<div>
