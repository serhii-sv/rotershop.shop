<?php
    ...
    */
    ...
    // Banner
    Route::get('admin/management/banner/delete/{id}', 'Backend\Management\BannerController@deleteBanner')->name('backend-management-banner-delete');
    Route::any('admin/management/banner/lang/{lang}/edit/{id}', 'Backend\Management\BannerController@showBannerEditPageLang')->name('lang-edit-banner');
    Route::get('admin/management/banner/edit/{id}', 'Backend\Management\BannerController@showBannerEditPage')->name('backend-management-banner-edit');
    Route::post('admin/management/banner/edit', 'Backend\Management\BannerController@editBannerForm')->name('backend-management-banner-edit-form');
    Route::get('admin/management/banner/add', 'Backend\Management\BannerController@showBannerAddPage')->name('backend-management-banner-add');
    Route::post('admin/management/banner/add', 'Backend\Management\BannerController@addBannerForm')->name('backend-management-banner-add-form');
    Route::get('admin/management/banners', 'Backend\Management\BannerController@showBannersPage')->name('backend-management-banners');
    Route::get('admin/management/banners/page/{page?}', 'Backend\Management\BannerController@showBannersPage')->name('backend-management-banners-with-pageNumber');
