                ...
                if ($request->get('user_edit_id')) {
                    ...
                    if ($user != null) {
                        ...
                        if (! $validator->fails()) {
                            ...
                            return redirect()->route('backend-management-users-with-pageNumber', 1)->with([
                        ...
                        return redirect()->route('backend-management-users-with-pageNumber', 1)->withErrors($validator)->withInput();
                    }
                }
            }
