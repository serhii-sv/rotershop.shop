                ...
                if ($request->get('article_edit_id')) {
                    ...
                    if ($article != null) {
                        ...
                        if (! $validator->fails()) {
                            ...
                            return redirect()->route('backend-management-articles-with-pageNumber', 1)->with([
                                'successMessage' => __('backend/main.changes_successfully'),
                            ]);
                        }
                        ...
                        return redirect()->route('backend-management-articles-with-pageNumber', 1)->withErrors($validator)->withInput();
                    }
                }
            }
