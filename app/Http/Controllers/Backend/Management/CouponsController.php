                ...
                if ($request->get('coupon_edit_id')) {
                    ...
                    if ($coupon != null) {
                        ...
                        if (! $validator->fails()) {
                            ...
                            return redirect()->route('backend-management-coupons-with-pageNumber', 1)->with([
                        ...
                        return redirect()->route('backend-management-coupons-with-pageNumber', 1)->withErrors($validator)->withInput();
                    }
                }
            }
