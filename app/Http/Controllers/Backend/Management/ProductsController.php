                ...
                if ($request->get('product_edit_id')) {
                    ...
                    if ($product != null) {
                        ...
                        if (! $validator->fails()) {
                            ...
                            return redirect()->route('backend-management-products-with-pageNumber')->with([
                                'successMessage' => __('backend/main.changes_successfully'),
                            ]);
                        }
                ...
                if (! $validator->fails()) {
                    ...
                    if ($product_add_stock_management == 'unlimited') {
                        ...
                        if ($validator_again->fails()) {
                            ...
                            return redirect()->route('backend-management-products-with-pageNumber', 1)->withErrors($validator_again)->withInput()->with([
                                'errorMessage' => __('backend/management.products.tiered_input_needed'),
                            ]);
                        }
                    ...
                    return redirect()->route('backend-management-products-with-pageNumber', 1)->with([
                        'successMessage' => __('backend/main.added_successfully'),
                    ]);
                }
                $request->flash();

                return redirect()->route('backend-management-products-with-pageNumber', 1)->withErrors($validator)->withInput();
            }
