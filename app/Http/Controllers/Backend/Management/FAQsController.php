                ...
                if ($request->get('faq_edit_id')) {
                    ...
                    if ($faq != null) {
                        if ($request->get('translation_lng') && strlen($request->get('translation_lng'))) {
                            ...
                            return redirect()->route('backend-management-faqs-with-pageNumber', 1)->with([
                        ...
                        return redirect()->route('backend-management-faqs-with-pageNumber', 1)->withErrors($validator)->withInput();
                    }
                }
            }
