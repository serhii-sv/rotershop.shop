        ...
        public function addTicketCategoryForm(Request $request)
        {
            if ($request->getMethod() == 'POST') {
                ...
                if (! $validator->fails()) {
                    ...
                    return redirect()->route('backend-management-tickets-categories-with-pageNumber', 1)->with([
                ...
                return redirect()->route('backend-management-tickets-categories-with-pageNumber', 1)->withErrors($validator)->withInput();
            }
