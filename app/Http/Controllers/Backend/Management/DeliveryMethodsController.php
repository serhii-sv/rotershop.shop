                ...
                if ($request->get('delivery_method_edit_id')) {
                    ...
                    if ($deliveryMethod != null) {
                        ...
                        if (! $validator->fails()) {
                            ...
                            return redirect()->route('backend-management-delivery-methods-with-pageNumber', 1)->with([
                        ...
                        return redirect()->route('backend-management-delivery-methods-with-pageNumber', 1)->withErrors($validator)->withInput();
                    }
                }
            }
