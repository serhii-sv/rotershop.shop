        ...
        public function addProductCategoryForm(Request $request)
        {
            if ($request->getMethod() == 'POST') {
                ...
                if (! $validator->fails()) {
                    ...
                    return redirect()->route('backend-management-products-categories-with-pageNumber', 1)->with([
                ...
                return redirect()->route('backend-management-products-categories-with-pageNumber', 1)->withErrors($validator)->withInput();
            }
