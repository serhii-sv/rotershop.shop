    ...
    class TicketsController extends Controller
    {
        ...
        public function closeTicket($id)
        {
            ...
            if ($ticket != null) {
                ...
                return redirect()->route('backend-management-tickets-with-pageNumber', 1)->with([
                    'successMessage' => __('backend/main.changes_successfully')]);
            }

            return redirect()->route('backend-management-tickets-with-pageNumber', 1)->withErrors($validator)->withInput();
        }
        ...
        public function showTicketsPage(Request $request, $pageNumber = 0)
        {
            ...
            for ($i=0; $i < count($tickets); $i++) { 
                $ticketReplies = UserTicketReply::where('ticket_id', $tickets[$i]->id)->get()->all();
                $tickets[$i]->ticketReplies = $ticketReplies;
            }
